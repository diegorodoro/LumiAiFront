...
const ShaderCanvas = ({
    ...
    useEffect(() => {
        const handleResize = () => {
            ...
            if (rendererRef.current && cameraRef.current && canvasSize.width > 0 && canvasSize.height > 0) {
                rendererRef.current.setSize(canvasSize.width, canvasSize.height);
                if (uniformsRef.current) {
                    uniformsRef.current.resolution.value.x = canvasSize.width;
                    uniformsRef.current.resolution.value.y = canvasSize.height;
                }
            }
        };
